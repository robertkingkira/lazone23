...
class EcommerceInstall extends Command
{
    ...
    {
        File::deleteDirectory(public_path('storage/products/images'));

        $this->callSilent('storage:link');

        $copySuccess = File::copyDirectory(public_path('img/products'), public_path('storage/products/images'));
        if ($copySuccess) {
