    ...
    <div class="auth-pages">
        <div class="auth-left">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <input type="email" id="email" value="{{ old('email') }}" placeholder="Email" required autofocus>

                <input type="password" id="password" value="{{ old('password') }}" placeholder="Password" required autofocus>
